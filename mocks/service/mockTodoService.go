...
// Source: todo-app-go-fiber/service (interfaces: TodoService)
...
import (
	reflect "reflect"
	dto "todo-app-go-fiber/dto"
	entity "todo-app-go-fiber/entity"
...
func (m *MockTodoService) TodoGetAll() ([]entity.Todo, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoService) TodoInsert(arg0 entity.Todo) (*dto.TodoDTO, error) {
	m.ctrl.T.Helper()
